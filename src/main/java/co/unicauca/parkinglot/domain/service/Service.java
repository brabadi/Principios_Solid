...
public class Service { 
    ...
    /**
     * 
     * Metodo que Calcula la tarifa de cada vehiculo dependiendo del tipo que sea
     * se llama a la clase que realiza la operacion.(Para no incumplir los proncipios solid)
     */
